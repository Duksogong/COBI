...
import ReviewImagesComponent from "../ReviewDetailPage/ReviewImagesComponent";
...
function HomePage() {
    ...
    useEffect(() => {
        ...
        //감상평 목록 설정 -> 초기 'feed'
        dispatch(getFeed()).then((response) => {
            ...
            >
                <Card>
                    <Card.Body
                        ...
                        style={{ width: "310px", height: "6rem" }}
                    >
                        <div
                            onClick={onDetailAdviceHandler}
                            style={{
                                display: "flex",
